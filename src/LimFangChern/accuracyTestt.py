...
model_path = 'efficientnet_gender_age_model.h5'  # Path to your .h5 model
...
predicted_age = predictions[0]   # Age predictions (if you have age output)
predicted_gender = predictions[1]  # Gender predictions (if you have gender output)
