...
vgg16_model = load_model('../ChinGianTerng/vgg16_age_gender_model.h5')
...
def process_frame(frame):
    ...
    for result in results:
        for box in result.boxes:
            ...
            age_gender_prediction = vgg16_model.predict(face_input)
...
# Function to convert the predicted age to an age group
